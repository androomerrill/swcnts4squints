...
"""
=============================================================
Periodic Table of Elements (:mod:`tasr.tools.periodic_table`)
=============================================================

.. currentmodule:: tasr.tools.periodic_table

.. autosummary::
   :toctree: generated/

   PeriodicTable  -- abstract data model representing the Periodic Table

"""
from __future__ import division, absolute_import, print_function
__docformat__ = 'restructuredtext'

from ._nist import atomic_masses as _atomic_masses

__all__ = ['atomic_masses', 'atomic_numbers',
